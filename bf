...
-- 新增: Toggle Button สำหรับแสดง/ซ่อน GUI
...
Background.BorderColor3 = Color3.fromRGB(60, 60, 65)
Background.BorderSizePixel = 1
Background.Position = UDim2.new(0, 500, 0, 200)
Background.Size = UDim2.new(0, 500, 0, 320)
Background.ClipsDescendants = true

-- เพิ่มมุมโค้งให้กับเฟรมหลัก
...
LeftPanel.Size = UDim2.new(0, 150, 0, 290)

-- เพิ่มมุมโค้งให้กับ LeftPanel
...
LogList.Size = UDim2.new(0, 140, 0, 280)
...
RemoteTemplate.Size = UDim2.new(0, 130, 0, 30)
...
ColorBar.Size = UDim2.new(0, 5, 0, 20)
ColorBar.ZIndex = 2

-- เพิ่มมุมโค้งให้กับ ColorBar
...
RightPanel.Size = UDim2.new(0, 350, 0, 290)

-- เพิ่มมุมโค้งให้กับ RightPanel
...
CodeBox.Size = UDim2.new(0, 350, 0, 160)

-- เพิ่มมุมโค้งให้กับ CodeBox
...
ScrollingFrame.Position = UDim2.new(0, 0, 0, 160)
ScrollingFrame.Size = UDim2.new(1, 0, 0, 130)
...
FunctionTemplate.Size = UDim2.new(0, 100, 0, 30)

ColorBar_2.Name = "ColorBar"
ColorBar_2.Parent = FunctionTemplate
ColorBar_2.BackgroundColor3 = Color3.fromRGB(0, 120, 215)
ColorBar_2.BorderSizePixel = 0
ColorBar_2.Position = UDim2.new(0, 5, 0, 5)
ColorBar_2.Size = UDim2.new(0, 5, 0, 20)
ColorBar_2.ZIndex = 3

-- เพิ่มมุมโค้งให้กับ ColorBar_2
local colorBar2Corner = Instance.new("UICorner")
colorBar2Corner.CornerRadius = UDim.new(0, 2)
colorBar2Corner.Parent = ColorBar_2

Text_2.Name = "Text"
Text_2.Parent = FunctionTemplate
Text_2.BackgroundColor3 = Color3.new(1, 1, 1)
Text_2.BackgroundTransparency = 1
Text_2.Position = UDim2.new(0, 15, 0, 5)
Text_2.Size = UDim2.new(0, 80, 0, 20)
Text_2.ZIndex = 2
Text_2.Font = Enum.Font.Gotham
Text_2.Text = "TEXT"
Text_2.TextColor3 = Color3.fromRGB(240, 240, 240)
Text_2.TextSize = 12
...
-- เพิ่มมุมโค้งให้กับ TopBar (เฉพาะด้านบน)
...
Simple.Size = UDim2.new(0, 120, 1, 0)
Simple.Font = Enum.Font.GothamBold
Simple.Text = "SimpleSpy v2.2"
Simple.TextColor3 = Color3.fromRGB(240, 240, 240)
Simple.TextSize = 14
...
ImageLabel.ImageColor3 = Color3.fromRGB(240, 240, 240)

MaximizeButton.Name = "MaximizeButton"
MaximizeButton.Parent = TopBar
MaximizeButton.BackgroundColor3 = Color3.fromRGB(25, 25, 30)
MaximizeButton.BorderSizePixel = 0
MaximizeButton.Position = UDim2.new(1, -55, 0, 5)
...
ImageLabel_2.ImageColor3 = Color3.fromRGB(240, 240, 240)
...
-- สร้าง Toggle Button สำหรับแสดง/ซ่อน GUI
...
-- เพิ่มมุมโค้งให้กับ ToggleButton
...
ToggleImage.BackgroundColor3 = Color3.new(1, 1, 1)
ToggleImage.BackgroundTransparency = 1
ToggleImage.Position = UDim2.new(0, 10, 0, 10)
ToggleImage.Size = UDim2.new(0, 20, 0, 20)
ToggleImage.Image = "http://www.roblox.com/asset/?id=6031094678"
ToggleImage.ImageColor3 = Color3.fromRGB(240, 240, 240)
...
-- ตัวแปรใหม่สำหรับการแสดง/ซ่อน GUI
local guiVisible = true

-- functions

--- ฟังก์ชันสำหรับแสดง/ซ่อน GUI
function toggleGUI()
    ...
    if guiVisible then
        ...
        TweenService:Create(Background, TweenInfo.new(0.3), {Size = UDim2.new(0, 500, 0, 320)}):Play()
        TweenService:Create(ToggleButton, TweenInfo.new(0.3), {BackgroundColor3 = Color3.fromRGB(0, 120, 215)}):Play()
        ToggleImage.Image = "http://www.roblox.com/asset/?id=6031094678"
    else
        -- ซ่อน GUI
        TweenService:Create(Background, TweenInfo.new(0.3), {Size = UDim2.new(0, 0, 0, 0)}):Play()
        TweenService:Create(ToggleButton, TweenInfo.new(0.3), {BackgroundColor3 = Color3.fromRGB(80, 80, 85)}):Play()
        ToggleImage.Image = "http://www.roblox.com/asset/?id=6031094667"
        
        -- หลังจากอนิเมชันเสร็จ ให้ซ่อนจริงๆ
        delay(0.3, function()
...
--- ฟังก์ชันสำหรับเปลี่ยนตำแหน่ง GUI
function setGUIPosition(position)
    TweenService:Create(Background, TweenInfo.new(0.2), {Position = position}):Play()
end

--- ฟังก์ชันสำหรับรีเซ็ตตำแหน่ง GUI
function resetGUIPosition()
    setGUIPosition(UDim2.new(0, 500, 0, 200))
end
...
if not _G.SimpleSpyExecuted then
	local succeeded, err = pcall(function()
		...
		-- เพิ่มการเชื่อมต่อสำหรับ Toggle Button
...
newButton("📋 Copy Code", function()
	return "Click to copy code to clipboard"
end, function()
...
-- เพิ่มปุ่มใหม่สำหรับการจัดการ GUI
newButton("👁️ Toggle GUI", function()
	return "Click to show/hide the SimpleSpy GUI"
end, function()
	toggleGUI()
	TextLabel.Text = guiVisible and "✅ GUI Visible" or "👁️‍🗨️ GUI Hidden"
end)

newButton("🔄 Reset Pos", function()
	return "Click to reset GUI position"
end, function()
	resetGUIPosition()
	TextLabel.Text = "✅ Position reset!"
end)
